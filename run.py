...
if __name__ == '__main__':
    ...
    parser.add_argument('--diffusion_steps', type=int, default=60, help='number of diffusion timesteps')
    parser.add_argument('--diffusion_beta_schedule', type=str, default='cosine', help='beta schedule for diffusion (linear|cosine)')
    ...
    parser.add_argument('--diffusion_dim', type=int, default=96, help='hidden dimension of diffusion decoder')
    parser.add_argument('--diffusion_heads', type=int, default=6, help='number of attention heads in diffusion decoder')
    parser.add_argument('--diffusion_depth', type=int, default=3, help='number of denoising blocks')
    parser.add_argument('--diffusion_eval_step', type=int, default=30, help='timestep used for inference-time noising (one-step mode)')
    parser.add_argument('--lambda_diff', type=float, default=1.0, help='weight for diffusion noise prediction loss')
    parser.add_argument('--lambda_rec', type=float, default=0.05, help='weight for conditional reconstruction head loss')
    parser.add_argument('--diffusion_sampling', type=str, default='ddim', help='sampling mode: one_step | ddim')
    parser.add_argument('--ddim_steps', type=int, default=20, help='number of DDIM denoising steps')
    parser.add_argument('--ddim_eta', type=float, default=0.0, help='DDIM stochasticity (0 for deterministic)')
